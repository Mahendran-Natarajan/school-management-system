package com.myschool.web.rest;

import com.myschool.SchoolManagementSystemApp;
import com.myschool.domain.JobHistory;
import com.myschool.repository.JobHistoryRepository;
import com.myschool.repository.search.JobHistorySearchRepository;
import com.myschool.service.JobHistoryService;
import com.myschool.web.rest.errors.ExceptionTranslator;
...
import static com.myschool.web.rest.TestUtil.createFormattingConversionService;
...
import com.myschool.domain.enumeration.Language;
/**
 * Integration tests for the {@link JobHistoryResource} REST controller.
 */
@SpringBootTest(classes = SchoolManagementSystemApp.class)
public class JobHistoryResourceIT {
    ...
    /**
     * This repository is mocked in the com.myschool.repository.search test package.
     *
     * @see com.myschool.repository.search.JobHistorySearchRepositoryMockConfiguration
     */
    @Autowired
