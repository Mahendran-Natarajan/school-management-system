...
describe('Region e2e test', () => {
  ...
  it('should load create Region page', async () => {
    ...
    expect(await regionUpdatePage.getPageTitle().getAttribute('id')).to.match(/schoolManagementSystemApp.region.home.createOrEditLabel/);
  ...
  it('should delete last Region', async () => {
    ...
    expect(await regionDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/schoolManagementSystemApp.region.delete.question/);
