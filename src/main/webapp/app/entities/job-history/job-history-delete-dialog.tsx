  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="schoolManagementSystemApp.jobHistory.delete.question">
          <Translate contentKey="schoolManagementSystemApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
