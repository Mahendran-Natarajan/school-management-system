    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="schoolManagementSystemApp.jobHistory.home.createOrEditLabel">
              <Translate contentKey="schoolManagementSystemApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="startDateLabel" for="job-history-startDate">
                    <Translate contentKey="schoolManagementSystemApp.jobHistory.startDate">Start Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="endDateLabel" for="job-history-endDate">
                    <Translate contentKey="schoolManagementSystemApp.jobHistory.endDate">End Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="languageLabel" for="job-history-language">
                    <Translate contentKey="schoolManagementSystemApp.jobHistory.language">Language</Translate>
                  </Label>
                  <AvInput
                  ...
                  >
                    <option value="FRENCH">{translate('schoolManagementSystemApp.Language.FRENCH')}</option>
                    <option value="ENGLISH">{translate('schoolManagementSystemApp.Language.ENGLISH')}</option>
                    <option value="SPANISH">{translate('schoolManagementSystemApp.Language.SPANISH')}</option>
                    <option value="TAMIL">{translate('schoolManagementSystemApp.Language.TAMIL')}</option>
                  </AvInput>
                </AvGroup>
                <AvGroup>
                  <Label for="job-history-job">
                    <Translate contentKey="schoolManagementSystemApp.jobHistory.job">Job</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="job-history-department">
                    <Translate contentKey="schoolManagementSystemApp.jobHistory.department">Department</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="job-history-employee">
                    <Translate contentKey="schoolManagementSystemApp.jobHistory.employee">Employee</Translate>
                  </Label>
