    ...
    return (
      <div>
        <h2 id="job-history-heading">
          <Translate contentKey="schoolManagementSystemApp.jobHistory.home.title">Job Histories</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="schoolManagementSystemApp.jobHistory.home.createLabel">Create a new Job History</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('schoolManagementSystemApp.jobHistory.home.search')}
                  />
          ...
          >
            {jobHistoryList && jobHistoryList.length > 0 ? (
              <Table responsive aria-describedby="job-history-heading">
                <thead>
                  <tr>
                    ...
                    <th>
                      <Translate contentKey="schoolManagementSystemApp.jobHistory.job">Job</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th>
                ...
                <tbody>
                  {jobHistoryList.map((jobHistory, i) => (
                    <tr key={`entity-${i}`}>
                      ...
                      <td>
                        <Translate contentKey={`schoolManagementSystemApp.Language.${jobHistory.language}`} />
                      </td>
              ...
              <div className="alert alert-warning">
                <Translate contentKey="schoolManagementSystemApp.jobHistory.home.notFound">No Job Histories found</Translate>
              </div>
            )}
          </InfiniteScroll>
        </div>
