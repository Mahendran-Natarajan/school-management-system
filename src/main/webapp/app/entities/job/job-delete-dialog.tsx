  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="schoolManagementSystemApp.job.delete.question">
          <Translate contentKey="schoolManagementSystemApp.job.delete.question" interpolate={{ id: jobEntity.id }}>
