  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="schoolManagementSystemApp.country.delete.question">
          <Translate contentKey="schoolManagementSystemApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
