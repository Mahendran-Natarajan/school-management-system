  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="schoolManagementSystemApp.task.delete.question">
          <Translate contentKey="schoolManagementSystemApp.task.delete.question" interpolate={{ id: taskEntity.id }}>
