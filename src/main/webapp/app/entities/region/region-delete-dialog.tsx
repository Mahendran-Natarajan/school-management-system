  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="schoolManagementSystemApp.region.delete.question">
          <Translate contentKey="schoolManagementSystemApp.region.delete.question" interpolate={{ id: regionEntity.id }}>
