    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="schoolManagementSystemApp.employee.home.createOrEditLabel">
              <Translate contentKey="schoolManagementSystemApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
