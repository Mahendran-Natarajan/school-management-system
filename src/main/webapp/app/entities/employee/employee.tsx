    ...
    return (
      <div>
        <h2 id="employee-heading">
          <Translate contentKey="schoolManagementSystemApp.employee.home.title">Employees</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="schoolManagementSystemApp.employee.home.createLabel">Create a new Employee</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('schoolManagementSystemApp.employee.home.search')}
                  />
          ...
          >
            {employeeList && employeeList.length > 0 ? (
                ...
                <thead>
                  <tr>
                    ...
                    <th className="hand" onClick={this.sort('email')}>
                      <Translate contentKey="schoolManagementSystemApp.employee.email">Email</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    ...
                    <th className="hand" onClick={this.sort('salary')}>
                      <Translate contentKey="schoolManagementSystemApp.employee.salary">Salary</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    ...
                    <th>
                      <Translate contentKey="schoolManagementSystemApp.employee.manager">Manager</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th>
              ...
              <div className="alert alert-warning">
                <Translate contentKey="schoolManagementSystemApp.employee.home.notFound">No Employees found</Translate>
              </div>
            )}
          </InfiniteScroll>
        </div>
