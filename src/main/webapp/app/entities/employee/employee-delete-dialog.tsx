  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="schoolManagementSystemApp.employee.delete.question">
          <Translate contentKey="schoolManagementSystemApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
