    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="schoolManagementSystemApp.location.home.createOrEditLabel">
              <Translate contentKey="schoolManagementSystemApp.location.home.createOrEditLabel">Create or edit a Location</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
