  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="schoolManagementSystemApp.location.delete.question">
          <Translate contentKey="schoolManagementSystemApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
