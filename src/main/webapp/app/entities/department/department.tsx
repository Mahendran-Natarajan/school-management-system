    ...
    return (
      <div>
        <h2 id="department-heading">
          <Translate contentKey="schoolManagementSystemApp.department.home.title">Departments</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="schoolManagementSystemApp.department.home.createLabel">Create a new Department</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('schoolManagementSystemApp.department.home.search')}
                  />
        ...
        <div className="table-responsive">
          {departmentList && departmentList.length > 0 ? (
            <Table responsive aria-describedby="department-heading">
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="schoolManagementSystemApp.department.departmentName">Department Name</Translate>
                  </th>
                  <th>
                    <Translate contentKey="schoolManagementSystemApp.department.location">Location</Translate>
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="schoolManagementSystemApp.department.home.notFound">No Departments found</Translate>
            </div>
          )}
        </div>
      </div>
