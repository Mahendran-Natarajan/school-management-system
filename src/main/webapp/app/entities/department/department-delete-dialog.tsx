  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="schoolManagementSystemApp.department.delete.question">
          <Translate contentKey="schoolManagementSystemApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
